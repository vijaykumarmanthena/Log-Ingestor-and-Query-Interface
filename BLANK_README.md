...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `vijaykumarmanthena`, `repo_name`, `twitter_handle`, `vijay-kumar-manthena`, `gmail`, `vijaykumarmantheena@gmail.com`, `Log Ingestor and Query Interface`, `Log injection collect logs and stores them and contains Querying Intrrface`
